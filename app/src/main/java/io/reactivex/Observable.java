...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <R> Observable<R> concatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, int i) {
        ...
        return objCall == null ? empty() : ObservableScalarXMap.scalarXMap(objCall, function);
    }
    ...
    public final void subscribe(Observer<? super T> observer) {
        ...
        try {
            ...
            ObjectHelper.requireNonNull(observerOnSubscribe, "Plugin returned null Observer");
