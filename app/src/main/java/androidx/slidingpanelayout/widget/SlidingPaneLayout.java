...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private void parallaxOtherViews(float f) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException, InvocationTargetException {
        boolean z;
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width != 0) {
                    ...
                    childAt.measure(layoutParams.width == -2 ? View.MeasureSpec.makeMeasureSpec(paddingLeft - i8, Integer.MIN_VALUE) : layoutParams.width == -1 ? View.MeasureSpec.makeMeasureSpec(paddingLeft - i8, 1073741824) : View.MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824), layoutParams.height == -2 ? View.MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE) : layoutParams.height == -1 ? View.MeasureSpec.makeMeasureSpec(paddingTop, 1073741824) : View.MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824));
                    int measuredWidth = childAt.getMeasuredWidth();
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i4 = i9;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i6)) / f)), 1073741824), iMakeMeasureSpec2);
                                }
                            }
                            ...
                            childAt2.measure(View.MeasureSpec.makeMeasureSpec(i9, i5), iMakeMeasureSpec);
                        }
                        i4 = i9;
                    }
                }
