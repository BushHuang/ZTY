...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls) throws NoSuchMethodException, SecurityException, IOException {
        ...
        if (zIsAssignableFrom) {
            try {
                t = this.mApplication != null ? (T) constructorFindMatchingConstructor.newInstance(this.mApplication, savedStateHandleControllerCreate.getHandle()) : (T) constructorFindMatchingConstructor.newInstance(savedStateHandleControllerCreate.getHandle());
