...
final class ImmLeaksCleaner implements LifecycleEventObserver {
    ...
    @Override
    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
