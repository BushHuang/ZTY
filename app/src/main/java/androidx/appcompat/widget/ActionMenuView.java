    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i14 > 0 && i9 > 0) {
            ...
            while (i20 < childCount) {
                ...
                if (layoutParams2.expandable) {
                    if (layoutParams2.cellsUsed < i21) {
                        i21 = layoutParams2.cellsUsed;
                        j2 = 1 << i20;
                        i19 = 1;
                    } else if (layoutParams2.cellsUsed == i21) {
                        i19++;
                        j2 |= 1 << i20;
                    }
                }
            ...
            while (i24 < childCount) {
                ...
                if ((j2 & j3) == 0) {
                    ...
                    if (z6 && layoutParams3.preventEdgeOffset && i9 == 1) {
                        ...
                        z3 = z6;
                        childAt2.setPadding(i27 + i11, 0, i27, 0);
                    } else {
                        z3 = z6;
                    }
        ...
        if (i9 <= 0 || j == 0 || (i9 >= i13 - 1 && !z9 && iMax2 <= 1)) {
            ...
            if (!z9) {
                ...
                if ((j & (1 << i28)) != 0 && !((LayoutParams) getChildAt(i28).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i29 = fBitCount > 0.0f ? (int) ((i9 * i11) / fBitCount) : 0;
            z2 = z;
