        ...
        if (i == -1 && i2 == -1) {
            ...
            if (i3 != -1 || i4 != -1) {
                ...
                if (i3 != -1 && i4 != -1) {
                    ...
                    int i5 = this.mParams.rightToRight;
                    ConstraintLayout.LayoutParams layoutParams2 = this.mParams;
                    if (i5 != -1) {
                        constraintProperties.connect(7, layoutParams2.rightToRight, 7, 0);
                    } else {
                        int i6 = layoutParams2.leftToLeft;
                        ConstraintLayout.LayoutParams layoutParams3 = this.mParams;
                        if (i6 != -1) {
                            constraintProperties2.connect(6, layoutParams3.leftToLeft, 6, 0);
                        }
                    }
                }
            }
            ...
            if (i != -1 && i2 != -1) {
                ...
                if (i7 != -1) {
                    constraintProperties3.connect(2, layoutParams4.rightToRight, 2, 0);
                } else {
                    int i8 = layoutParams4.leftToLeft;
                    ConstraintLayout.LayoutParams layoutParams5 = this.mParams;
                    if (i8 != -1) {
                        constraintProperties4.connect(1, layoutParams5.leftToLeft, 1, 0);
                    }
                }
            }
            removeConstraints(1);
