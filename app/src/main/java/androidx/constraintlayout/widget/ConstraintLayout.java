...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i7 == 1) {
                ...
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i6 + constraintWidget.getHorizontalMargin(), -1);
            } else if (i7 != 4) {
                iMakeMeasureSpec = 0;
            } else {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i6, -2);
            ...
            int i8 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintWidget$DimensionBehaviour[dimensionBehaviour2.ordinal()];
            if (i8 == 1) {
                ...
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i5 + constraintWidget.getVerticalMargin(), -1);
            } else if (i8 != 4) {
                iMakeMeasureSpec2 = 0;
            } else {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i5, -2);
    ...
    protected void applyConstraintsFromLayoutParams(boolean z, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) throws NumberFormatException {
        int i;
        int i2;
        float f;
        ...
        if (layoutParams.circleConstraint != -1) {
            ...
            if (i5 != -1) {
                ...
                if (i6 != -1 && (constraintWidget2 = sparseArray.get(i6)) != null) {
                    constraintWidget.immediateConnect(ConstraintAnchor.Type.LEFT, constraintWidget2, ConstraintAnchor.Type.RIGHT, layoutParams.leftMargin, i9);
                }
            }
            if (i2 != -1) {
                ...
                constraintWidget.immediateConnect(ConstraintAnchor.Type.RIGHT, constraintWidget3, ConstraintAnchor.Type.RIGHT, layoutParams.rightMargin, i);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.mDirtyHierarchy) {
            ...
            if (this.mOnMeasureWidthMeasureSpec == i && View.MeasureSpec.getMode(i) == 1073741824 && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE && View.MeasureSpec.getMode(this.mOnMeasureHeightMeasureSpec) == Integer.MIN_VALUE && View.MeasureSpec.getSize(i2) >= this.mLayoutWidget.getHeight()) {
    ...
    protected void resolveMeasuredDimension(int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        int iResolveSizeAndState = resolveSizeAndState(i6, i, 0);
        int iResolveSizeAndState2 = resolveSizeAndState(i7, i2, 0) & 16777215;
