...
public abstract class WidgetRun implements Dependency {
    ...
    private void resolveDimension(int i, int i2) {
        ...
        if ((i == 0 ? constraintWidget2.verticalRun : constraintWidget2.horizontalRun).dimension.resolved) {
            ...
            this.dimension.resolve(i == 1 ? (int) ((r6.dimension.value / dimensionRatio) + 0.5f) : (int) ((dimensionRatio * r6.dimension.value) + 0.5f));
        }
    }
    ...
    protected final int getLimitedDimension(int i, int i2) {
        ...
        if (i2 == 0) {
            ...
            iMax = Math.max(this.widget.mMatchConstraintMinWidth, i);
            if (i3 > 0) {
                iMax = Math.min(i3, i);
            }
            if (iMax == i) {
            ...
            iMax = Math.max(this.widget.mMatchConstraintMinHeight, i);
            if (i4 > 0) {
                iMax = Math.min(i4, i);
            }
            if (iMax == i) {
