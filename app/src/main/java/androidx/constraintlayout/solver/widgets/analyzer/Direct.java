...
public class Direct {
    ...
    public static boolean solveChain(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead, boolean z, boolean z2, boolean z3) {
        ...
        while (true) {
            ...
            if (z4) {
                ...
                if (i5 == 0 || i5 != i6 || finalValue3 < margin) {
                    return false;
                }
                int i7 = finalValue3 - margin;
                if (!z) {
                    if (z2 && i5 > 2) {
                        i3 = 1;
                        i7 = (i7 / i5) - 1;
                    ...
                    if (i5 != i3) {
                        int horizontalBiasPercent = (int) (finalValue + 0.5f + (i7 * (i == 0 ? head.getHorizontalBiasPercent() : head.getVerticalBiasPercent())));
                        if (i == 0) {
                    ...
                    if (z) {
                        ...
                        while (!z5) {
                            ...
                            if (constraintWidget5.getVisibility() != 8) {
                                int margin3 = margin2 + constraintWidget5.mListAnchors[i2].getMargin();
                                if (i == 0) {
                                ...
                                margin2 = margin3 + height + constraintWidget5.mListAnchors[i4].getMargin() + i7;
                            } else if (i == 0) {
                ...
                margin = margin + constraintWidget2.mListAnchors[i2].getMargin() + (i == 0 ? constraintWidget2.getWidth() : constraintWidget2.getHeight()) + constraintWidget2.mListAnchors[i4].getMargin();
                i6++;
    ...
    private static void solveHorizontalMatchConstraint(ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2, boolean z) {
        ...
        if (finalValue2 >= finalValue) {
            ...
            int i = finalValue + ((int) ((horizontalBiasPercent * ((finalValue2 - finalValue) - width)) + 0.5f));
            constraintWidget2.setFinalHorizontal(i, width + i);
            horizontalSolvingPass(constraintWidget2, measurer, z);
        }
    }
    ...
    private static void solveVerticalMatchConstraint(ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2) {
        ...
        if (finalValue2 >= finalValue) {
            ...
            int i = finalValue + ((int) ((verticalBiasPercent * ((finalValue2 - finalValue) - height)) + 0.5f));
            constraintWidget2.setFinalVertical(i, height + i);
