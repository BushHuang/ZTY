...
public final class DrawableKt {
    public static final Bitmap toBitmap(Drawable drawable, int i, int i2, Bitmap.Config config) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(bitmapCreateBitmap, "bitmap");
        return bitmapCreateBitmap;
    }

    public static Bitmap toBitmap$default(Drawable drawable, int i, int i2, Bitmap.Config config, int i3, Object obj) {
        if ((i3 & 1) != 0) {
    ...
    public static void updateBounds$default(Drawable drawable, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
