...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        @Override
        public void subscribe(String str, Bundle bundle, SubscriptionCallback subscriptionCallback) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            Subscription subscription = this.mSubscriptions.get(str);
            if (subscription == null) {
        ...
        @Override
        public void unsubscribe(String str, SubscriptionCallback subscriptionCallback) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            Subscription subscription = this.mSubscriptions.get(str);
            if (subscription == null) {
                return;
            }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        @Override
        public void onServiceConnected(Messenger messenger, String str, MediaSessionCompat.Token token, Bundle bundle) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    private static class ServiceBinderWrapper {
        ...
        void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws IllegalAccessException, NoSuchMethodException, SecurityException, RemoteException, IllegalArgumentException, InvocationTargetException {
        ...
        void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws IllegalAccessException, NoSuchMethodException, SecurityException, RemoteException, IllegalArgumentException, InvocationTargetException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
