...
public final class Http2Codec implements HttpCodec {
    ...
    static {
        ByteString byteStringEncodeUtf8 = ByteString.encodeUtf8("upgrade");
        UPGRADE = byteStringEncodeUtf8;
        HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList(CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, TE, TRANSFER_ENCODING, ENCODING, byteStringEncodeUtf8, Header.TARGET_METHOD, Header.TARGET_PATH, Header.TARGET_SCHEME, Header.TARGET_AUTHORITY);
