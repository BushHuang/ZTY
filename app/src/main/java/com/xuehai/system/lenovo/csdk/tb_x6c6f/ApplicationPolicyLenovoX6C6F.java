...
public final class ApplicationPolicyLenovoX6C6F extends ApplicationPolicyDefault {
    ...
    public boolean removeDefaultLauncher(String packageName, String className) {
        Intrinsics.checkNotNullParameter(packageName, "packageName");
        Intrinsics.checkNotNullParameter(className, "className");
        this.csdkManager.setCustomLauncher("com.android.launcher3", null);
        return true;
    }
