...
public final class RestrictionPolicyLenovoX6C6F extends RestrictionPolicyDefault {
    ...
    public boolean allowUsbHostStorage(boolean allow) {
        ...
        this.csdkManager.setCurrentUsbMode(allow ? 1 : 0);
        return true;
    }
