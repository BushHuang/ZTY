...
public class RootKeyUtil {
    ...
    private void a(String str, String str2, String str3, byte[] bArr) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            this.f401a = BaseKeyUtil.exportRootKey(str, str2, str3, bArr, false);
        } else {
            b.c(b, "initRootKey: sha256");
            this.f401a = BaseKeyUtil.exportRootKey(str, str2, str3, bArr, true);
        }
    }
    ...
    public byte[] getRootKey() {
        return (byte[]) this.f401a.clone();
    }

    public String getRootKeyHex() {
        return HexUtil.byteArray2HexStr(this.f401a);
    }
}
