...
public class a extends AGConnectInstance {
    ...
    private static List<Service> f174a;
    ...
    public a(AGConnectOptions aGConnectOptions) {
        ...
        if (aGConnectOptions instanceof com.huawei.agconnect.config.a.b) {
            cVar.a(((com.huawei.agconnect.config.a.b) aGConnectOptions).a());
        }
    }
    ...
    private static AGConnectInstance a(AGConnectOptions aGConnectOptions, boolean z) {
        AGConnectInstance aVar;
        synchronized (b) {
            aVar = c.get(aGConnectOptions.getIdentifier());
            if (aVar == null || z) {
                aVar = new a(aGConnectOptions);
                c.put(aGConnectOptions.getIdentifier(), aVar);
            }
        }
        return aVar;
    }
    ...
    public void a(final CustomAuthProvider customAuthProvider) {
        this.f.a(Collections.singletonList(Service.builder((Class<?>) AuthProvider.class, new AuthProvider() {
            @Override
    ...
    public void a(final CustomCredentialsProvider customCredentialsProvider) {
        this.f.a(Collections.singletonList(Service.builder((Class<?>) CredentialsProvider.class, new CredentialsProvider() {
            @Override
            public Task<Token> getTokens() {
