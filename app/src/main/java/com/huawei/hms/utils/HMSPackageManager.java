...
public class HMSPackageManager {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            Iterator<ResolveInfo> it = HMSPackageManager.this.f375a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128).iterator();
            while (it.hasNext()) {
    ...
    public final boolean a(String str, String str2, String str3) {
        ...
        if (!com.huawei.hms.device.a.a(com.huawei.hms.device.a.a(this.f375a), listB)) {
    ...
    public final boolean b() {
        String hmsPath = ReadApkFileUtil.getHmsPath(this.f375a);
        if (hmsPath == null) {
    ...
    public final Pair<String, String> f() throws PackageManager.NameNotFoundException {
        List<ResolveInfo> listQueryIntentServices = this.f375a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
    ...
    public final ArrayList<b> h() throws PackageManager.NameNotFoundException {
        List<ResolveInfo> listQueryIntentServices = this.f375a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core"), 128);
