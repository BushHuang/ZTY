...
public final class ConnectService {
    ...
    static class b extends PendingResultImpl<ResolveResult<ConnectResp>, ConnectResp> {
    ...
    static class c extends PendingResultImpl<ResolveResult<JosGetNoticeResp>, JosGetNoticeResp> {
