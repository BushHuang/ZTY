...
public class d {
    ...
    public static final Charset f291a = Charset.forName("UTF-8");
    ...
    public static String a(String str, String str2) {
        ...
        return new String(AesCbc.decrypt(HexUtil.hexStr2ByteArray((String) pairA.second), HexUtil.hexStr2ByteArray(str2), (byte[]) pairA.first), f291a);
    }
    ...
    public static String b(String str, String str2) {
        return HexUtil.byteArray2HexStr(AesCbc.encrypt(str.getBytes(f291a), HexUtil.hexStr2ByteArray(str2)));
    }
}
