...
public class v0 {
    ...
    public static boolean b(String str) {
        if (k1.f307a.booleanValue()) {
            return true;
        }
        for (String str2 : f326a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
