    ...
    public static final class Builder {
        ...
        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            ...
            if ("HuaweiGame.API".equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(this.f224a.getApplicationContext(), "15060106", "|" + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f224a);
