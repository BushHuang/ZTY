...
public abstract class HuaweiApiAvailability {
    ...
    private static final Map<String, Integer> f223a;

    static {
        HashMap map = new HashMap();
        f223a = map;
        map.put("HuaweiID.API", 30000000);
        f223a.put("HuaweiSns.API", 20503000);
        f223a.put("HuaweiPay.API", 20503000);
        f223a.put("HuaweiPush.API", 20503000);
        f223a.put("HuaweiGame.API", 20503000);
        f223a.put("HuaweiOpenDevice.API", 20601000);
        f223a.put("HuaweiIap.API", 20700300);
        f223a.put("HuaweiPPSkit.API", 20700300);
    }
