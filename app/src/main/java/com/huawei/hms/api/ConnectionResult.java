...
public final class ConnectionResult implements Parcelable {
    ...
    ConnectionResult(Parcel parcel, a aVar) {
        this(parcel);
    }
    ...
    public boolean equals(Object obj) {
        ...
        try {
            if ((obj instanceof ConnectionResult) && this.f221a == ((ConnectionResult) obj).f221a && this.d == ((ConnectionResult) obj).d && this.c.equals(((ConnectionResult) obj).c)) {
    ...
    public int hashCode() {
        return Objects.hashCode(Long.valueOf(this.f221a), Long.valueOf(getErrorCode()), getErrorMessage(), this.b);
    }
