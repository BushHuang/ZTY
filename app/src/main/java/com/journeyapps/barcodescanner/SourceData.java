...
public class SourceData {
    ...
    public PlanarYUVLuminanceSource createSource() {
        ...
        return isRotated() ? new PlanarYUVLuminanceSource(bArrRotateCameraPreview, this.dataHeight, this.dataWidth, this.cropRect.left, this.cropRect.top, this.cropRect.width(), this.cropRect.height(), false) : new PlanarYUVLuminanceSource(bArrRotateCameraPreview, this.dataWidth, this.dataHeight, this.cropRect.left, this.cropRect.top, this.cropRect.width(), this.cropRect.height(), false);
    }
