...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
            ...
            while (true) {
                if (i2 < iMin) {
                    ...
                    if (iArr[i_decodeFastCharEscape] == 0 || i_decodeFastCharEscape == 34) {
                        ...
                        this._inputPtr = i5;
                        this._textBuffer.setCurrentLength(currentSegmentSize);
                        if (!_decodeSplitMultiByte(i_decodeFastCharEscape, iArr[i_decodeFastCharEscape], i5 < this._inputEnd)) {
                        ...
                        int i6 = iArr[i_decodeFastCharEscape];
                        if (i6 == 1) {
                            this._inputPtr = i5;
                            i_decodeFastCharEscape = _decodeFastCharEscape();
                            i = this._inputPtr;
                        } else if (i6 == 2) {
                            i_decodeFastCharEscape = _decodeUTF8_2(i_decodeFastCharEscape, this._inputBuffer[i5]);
                            i = i5 + 1;
                        } else if (i6 == 3) {
                            byte[] bArr2 = this._inputBuffer;
                            int i7 = i5 + 1;
                            i_decodeFastCharEscape = _decodeUTF8_3(i_decodeFastCharEscape, bArr2[i5], bArr2[i7]);
                            i = i7 + 1;
                        } else if (i6 != 4) {
                            ...
                            int i9 = i8 + 1;
                            int i10 = i9 + 1;
                            int i_decodeUTF8_4 = _decodeUTF8_4(i_decodeFastCharEscape, bArr3[i5], bArr3[i8], bArr3[i9]);
                            ...
                            i_decodeFastCharEscape = (i_decodeUTF8_4 & 1023) | 56320;
                            i = i10;
                        }
                        if (currentSegmentSize >= bufferWithoutReset.length) {
                            bufferWithoutReset = this._textBuffer.finishCurrentSegment();
                        ...
                        bufferWithoutReset[i4] = (char) i_decodeFastCharEscape;
                        i2 = i;
                    }
                }
            }
    ...
    private final JsonToken _startFieldNameAfterComma(int i) throws IOException {
        ...
        if (i_skipWS > 32 || (i_skipWS = _skipWS(i_skipWS)) > 0) {
            _updateTokenLocation();
            return i_skipWS != 34 ? (i_skipWS == 125 && JsonParser.Feature.ALLOW_TRAILING_COMMA.enabledIn(this._features)) ? _closeObjectScope() : _handleOddName(i_skipWS) : (this._inputPtr + 13 > this._inputEnd || (str_fastParseName = _fastParseName()) == null) ? _parseEscapedName(0, 0, 0) : _fieldComplete(str_fastParseName);
        }
        this._minorState = 4;
        return this._currToken;
    }
