...
public class AnnotationIntrospectorPair extends AnnotationIntrospector implements Serializable {
    ...
    public PropertyName findNameForDeserialization(Annotated annotated) {
        ...
        return propertyNameFindNameForDeserialization2 == null ? this._secondary.findNameForDeserialization(annotated) : (propertyNameFindNameForDeserialization2 != PropertyName.USE_DEFAULT || (propertyNameFindNameForDeserialization = this._secondary.findNameForDeserialization(annotated)) == null) ? propertyNameFindNameForDeserialization2 : propertyNameFindNameForDeserialization;
    }
    ...
    public PropertyName findNameForSerialization(Annotated annotated) {
        ...
        return propertyNameFindNameForSerialization2 == null ? this._secondary.findNameForSerialization(annotated) : (propertyNameFindNameForSerialization2 != PropertyName.USE_DEFAULT || (propertyNameFindNameForSerialization = this._secondary.findNameForSerialization(annotated)) == null) ? propertyNameFindNameForSerialization2 : propertyNameFindNameForSerialization;
    }
    ...
    public PropertyName findRootName(AnnotatedClass annotatedClass) {
        ...
        return propertyNameFindRootName2 == null ? this._secondary.findRootName(annotatedClass) : (propertyNameFindRootName2.hasSimpleName() || (propertyNameFindRootName = this._secondary.findRootName(annotatedClass)) == null) ? propertyNameFindRootName2 : propertyNameFindRootName;
    }
    ...
    public PropertyName findWrapperName(Annotated annotated) {
        ...
        return propertyNameFindWrapperName2 == null ? this._secondary.findWrapperName(annotated) : (propertyNameFindWrapperName2 != PropertyName.USE_DEFAULT || (propertyNameFindWrapperName = this._secondary.findWrapperName(annotated)) == null) ? propertyNameFindWrapperName2 : propertyNameFindWrapperName;
    }
