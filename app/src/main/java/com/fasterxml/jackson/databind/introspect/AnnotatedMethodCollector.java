...
public class AnnotatedMethodCollector extends CollectorBase {
    ...
    AnnotatedMethodMap collect(TypeFactory typeFactory, TypeResolutionContext typeResolutionContext, JavaType javaType, List<JavaType> list, Class<?> cls) throws NoSuchMethodException, SecurityException {
        boolean z;
