...
public class StdValueInstantiator extends ValueInstantiator implements Serializable {
    ...
    public Object createUsingDelegate(DeserializationContext deserializationContext, Object obj) throws IOException {
        ...
        return (this._delegateCreator != null || (annotatedWithParams = this._arrayDelegateCreator) == null) ? _createUsingDelegate(this._delegateCreator, this._delegateArguments, deserializationContext, obj) : _createUsingDelegate(annotatedWithParams, this._arrayDelegateArguments, deserializationContext, obj);
    }
