    ...
    public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper jsonFormatVisitorWrapper, JavaType javaType) throws JsonMappingException {
        ...
        if (jsonArrayFormatVisitorExpectArrayFormat != null) {
            ...
            if (jsonSerializerFindValueSerializer == null) {
                jsonSerializerFindValueSerializer = jsonFormatVisitorWrapper.getProvider().findValueSerializer(javaType2, this._property);
            }
            jsonArrayFormatVisitorExpectArrayFormat.itemsFormat(jsonSerializerFindValueSerializer, javaType2);
        }
    }
