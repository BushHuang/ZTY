...
public class CollectionLikeType extends TypeBase {
    ...
    public static CollectionLikeType construct(Class<?> cls, JavaType javaType) {
        ...
        return new CollectionLikeType(cls, (typeParameters == null || typeParameters.length != 1) ? TypeBindings.emptyBindings() : TypeBindings.create(cls, javaType), _bogusSuperClass(cls), null, javaType, null, null, false);
    }
