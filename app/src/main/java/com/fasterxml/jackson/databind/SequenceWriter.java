...
public class SequenceWriter implements Versioned, Closeable, Flushable {
    ...
    private final JsonSerializer<Object> _findAndAddDynamic(JavaType javaType) throws JsonMappingException {
        ...
        PropertySerializerMap.SerializerAndMapResult serializerAndMapResultFindAndAddRootValueSerializer = typeSerializer == null ? this._dynamicSerializers.findAndAddRootValueSerializer(javaType, this._provider) : this._dynamicSerializers.addSerializer(javaType, new TypeWrappedSerializer(typeSerializer, this._provider.findValueSerializer(javaType, (BeanProperty) null)));
