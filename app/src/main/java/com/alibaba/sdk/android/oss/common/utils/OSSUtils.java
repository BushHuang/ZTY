...
public class OSSUtils {
    ...
    public static void populateCopyObjectHeaders(CopyObjectRequest copyObjectRequest, Map<String, String> map) {
        map.put("x-oss-copy-source", "/" + copyObjectRequest.getSourceBucketName() + "/" + HttpUtil.urlEncode(copyObjectRequest.getSourceKey(), "utf-8"));
        addDateHeader(map, "x-oss-copy-source-if-modified-since", copyObjectRequest.getModifiedSinceConstraint());
        addDateHeader(map, "x-oss-copy-source-if-unmodified-since", copyObjectRequest.getUnmodifiedSinceConstraint());
        addStringListHeader(map, "x-oss-copy-source-if-match", copyObjectRequest.getMatchingETagConstraints());
        addStringListHeader(map, "x-oss-copy-source-if-none-match", copyObjectRequest.getNonmatchingEtagConstraints());
        addHeader(map, "x-oss-server-side-encryption", copyObjectRequest.getServerSideEncryption());
    ...
    public static void populateListBucketRequestParameters(ListBucketsRequest listBucketsRequest, Map<String, String> map) {
        if (listBucketsRequest.getPrefix() != null) {
            map.put("prefix", listBucketsRequest.getPrefix());
        }
        if (listBucketsRequest.getMarker() != null) {
            map.put("marker", listBucketsRequest.getMarker());
        }
        if (listBucketsRequest.getMaxKeys() != null) {
            map.put("max-keys", Integer.toString(listBucketsRequest.getMaxKeys().intValue()));
        }
    }
    ...
    public static void populateListMultipartUploadsRequestParameters(ListMultipartUploadsRequest listMultipartUploadsRequest, Map<String, String> map) {
        ...
        if (listMultipartUploadsRequest.getMaxUploads() != null) {
            map.put("max-uploads", Integer.toString(listMultipartUploadsRequest.getMaxUploads().intValue()));
        }
        ...
        if (listMultipartUploadsRequest.getEncodingType() != null) {
            map.put("encoding-type", listMultipartUploadsRequest.getEncodingType());
        }
    }
    ...
    public static void populateListObjectsRequestParameters(ListObjectsRequest listObjectsRequest, Map<String, String> map) {
        ...
        if (listObjectsRequest.getEncodingType() != null) {
            map.put("encoding-type", listObjectsRequest.getEncodingType());
        }
    }
    ...
    public static void signRequest(RequestMessage requestMessage) throws Exception {
        ...
        if (requestMessage.isAuthorizationRequired()) {
            ...
            if (z) {
                ...
                requestMessage.getHeaders().put("x-oss-security-token", federationToken.getSecurityToken());
    ...
    public static boolean validateObjectKey(String str) throws UnsupportedEncodingException {
