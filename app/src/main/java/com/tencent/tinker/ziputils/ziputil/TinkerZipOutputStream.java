...
public class TinkerZipOutputStream extends FilterOutputStream implements ZipConstants {
    ...
    public void closeEntry() throws IOException {
        ...
        long compressedSize = j + (this.currentEntry.getMethod() == 8 ? this.currentEntry.getCompressedSize() : this.currentEntry.getSize());
        ...
        if (this.currentEntry.extra != null) {
            jWriteIntAsUint16 += writeIntAsUint16(this.cDir, this.currentEntry.extra.length);
        } else {
    ...
    public void putNextEntry(TinkerZipEntry tinkerZipEntry) throws IOException {
        ...
        writeIntAsUint16(this.out, i | 2048);
