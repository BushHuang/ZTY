...
public final class CompareUtils {
    ...
    public static <T extends Comparable<T>> int aArrCompare(T[] tArr, T[] tArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iCompareTo = tArr[i].compareTo(tArr2[i]);
            if (iCompareTo != 0) {
                return iCompareTo;
            }
        }
    ...
    public static <T> int aArrCompare(T[] tArr, T[] tArr2, Comparator<T> comparator) {
        ...
        for (int i = 0; i < length; i++) {
            int iCompare = comparator.compare(tArr[i], tArr2[i]);
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int sArrCompare(byte[] bArr, byte[] bArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iSCompare = sCompare(bArr[i], bArr2[i]);
            if (iSCompare != 0) {
                return iSCompare;
            }
        }
    ...
    public static int sArrCompare(int[] iArr, int[] iArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iSCompare = sCompare(iArr[i], iArr2[i]);
            if (iSCompare != 0) {
                return iSCompare;
            }
        }
    ...
    public static int sArrCompare(long[] jArr, long[] jArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iSCompare = sCompare(jArr[i], jArr2[i]);
            if (iSCompare != 0) {
                return iSCompare;
            }
        }
    ...
    public static int sArrCompare(short[] sArr, short[] sArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iSCompare = sCompare(sArr[i], sArr2[i]);
            if (iSCompare != 0) {
                return iSCompare;
            }
        }
    ...
    public static int uArrCompare(byte[] bArr, byte[] bArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iUCompare = uCompare(bArr[i], bArr2[i]);
            if (iUCompare != 0) {
                return iUCompare;
            }
        }
    ...
    public static int uArrCompare(int[] iArr, int[] iArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iUCompare = uCompare(iArr[i], iArr2[i]);
            if (iUCompare != 0) {
                return iUCompare;
            }
        }
    ...
    public static int uArrCompare(short[] sArr, short[] sArr2) {
        ...
        for (int i = 0; i < length; i++) {
            int iUCompare = uCompare(sArr[i], sArr2[i]);
            if (iUCompare != 0) {
                return iUCompare;
            }
        }
