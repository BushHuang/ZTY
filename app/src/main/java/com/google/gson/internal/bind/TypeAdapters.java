...
public final class TypeAdapters {
    ...
    static {
        ...
        TypeAdapter<StringBuilder> typeAdapter2 = new TypeAdapter<StringBuilder>() {
            @Override
        ...
        TypeAdapter<StringBuffer> typeAdapter3 = new TypeAdapter<StringBuffer>() {
            @Override
        ...
        TypeAdapter<URL> typeAdapter4 = new TypeAdapter<URL>() {
            @Override
        ...
        TypeAdapter<InetAddress> typeAdapter6 = new TypeAdapter<InetAddress>() {
            @Override
        ...
        TypeAdapter<UUID> typeAdapter7 = new TypeAdapter<UUID>() {
            @Override
        ...
        TypeAdapter<Calendar> typeAdapter8 = new TypeAdapter<Calendar>() {
        ...
        TypeAdapter<Locale> typeAdapter9 = new TypeAdapter<Locale>() {
            @Override
        ...
        TypeAdapter<JsonElement> typeAdapter10 = new TypeAdapter<JsonElement>() {
            @Override
