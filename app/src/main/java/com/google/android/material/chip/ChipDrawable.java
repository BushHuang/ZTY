...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    public static ChipDrawable createFromResource(Context context, int i) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        try {
            ...
            return createFromAttributes(context, attributeSetAsAttributeSet, R.attr.chipStandaloneStyle, styleAttribute);
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i, int i2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        setChipCornerRadius(typedArrayObtainStyledAttributes.getDimension(R.styleable.Chip_chipCornerRadius, 0.0f));
        ...
        setTextAppearance(MaterialResources.getTextAppearance(this.context, typedArrayObtainStyledAttributes, R.styleable.Chip_android_textAppearance));
        int i3 = typedArrayObtainStyledAttributes.getInt(R.styleable.Chip_android_ellipsize, 0);
        if (i3 == 1) {
        ...
        setChipIconTint(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, R.styleable.Chip_chipIconTint));
        setChipIconSize(typedArrayObtainStyledAttributes.getDimension(R.styleable.Chip_chipIconSize, 0.0f));
