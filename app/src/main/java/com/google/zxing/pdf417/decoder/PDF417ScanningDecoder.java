...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, ChecksumException, FormatException {
        ...
        int iMin = i;
        int iMax = i2;
        for (int i7 = 1; i7 <= barcodeColumnCount; i7++) {
            int i8 = z ? i7 : barcodeColumnCount - i7;
            if (detectionResultMerge.getDetectionResultColumn(i8) == null) {
                DetectionResultColumn detectionResultRowIndicatorColumn = (i8 == 0 || i8 == barcodeColumnCount) ? new DetectionResultRowIndicatorColumn(boundingBox, i8 == 0) : new DetectionResultColumn(boundingBox);
                detectionResultMerge.setDetectionResultColumn(i8, detectionResultRowIndicatorColumn);
                int i9 = -1;
                int minY = boundingBox.getMinY();
                int i10 = -1;
                while (minY <= boundingBox.getMaxY()) {
                    int startColumn = getStartColumn(detectionResultMerge, i8, minY, z);
                    ...
                    i3 = i10;
                    int i11 = minY;
                    Codeword codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z, i5, i11, iMin, iMax);
                    i4 = i11;
                    if (codewordDetectCodeword != null) {
                        detectionResultRowIndicatorColumn.setCodeword(i4, codewordDetectCodeword);
