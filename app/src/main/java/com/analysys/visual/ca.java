...
public class ca {
    ...
    static final boolean f141a = !ca.class.desiredAssertionStatus();
    ...
    public static class a extends FilterOutputStream {
        ...
        public void a() throws IOException {
            if (this.b > 0) {
                ...
                this.out.write(ca.b(this.g, this.c, this.b, this.i));
                this.b = 0;
            }
        }
        ...
        public void write(int i) throws IOException {
            ...
            if (this.f142a) {
                ...
                bArr[i2] = (byte) i;
                if (i3 >= this.d) {
                    this.out.write(ca.b(this.g, this.c, this.d, this.i));
                    int i4 = this.e + 4;
                    this.e = i4;
                    if (this.f && i4 >= 76) {
                        this.out.write(10);
            ...
            bArr3[i6] = (byte) i;
            if (i7 >= this.d) {
                this.out.write(this.g, 0, ca.b(bArr3, 0, this.g, 0, this.i));
                this.b = 0;
            }
        }
