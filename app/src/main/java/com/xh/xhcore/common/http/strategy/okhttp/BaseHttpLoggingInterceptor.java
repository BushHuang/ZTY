...
public final class BaseHttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws Exception {
        ...
        if (z4) {
            ...
            z = z4;
            if (!z3 || !z5 || requestBodyBody.contentLength() > 4096) {
        ...
        try {
            ...
            if (z) {
                ...
                if (!z3 || !HttpHeaders.hasBody(responseProceed) || jContentLength > 4096) {
