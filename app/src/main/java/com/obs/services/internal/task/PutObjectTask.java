...
public class PutObjectTask implements Runnable {
    ...
    private void putObjects() {
        ...
        try {
            try {
                PutObjectResult putObjectResultPutObject = this.obsClient.putObject(this.taskRequest);
                this.taskStatus.succeedTaskIncrement();
                this.callback.onSuccess(new PutObjectResult(putObjectResultPutObject.getBucketName(), putObjectResultPutObject.getObjectKey(), putObjectResultPutObject.getEtag(), putObjectResultPutObject.getVersionId(), putObjectResultPutObject.getObjectUrl(), putObjectResultPutObject.getResponseHeaders(), putObjectResultPutObject.getStatusCode()));
