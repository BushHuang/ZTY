...
public class Constants {
    ...
    public static final List<String> ALLOWED_REQUEST_HTTP_HEADER_METADATA_NAMES;
    public static final List<String> ALLOWED_RESOURCE_PARAMTER_NAMES;
    public static final List<String> ALLOWED_RESPONSE_HTTP_HEADER_METADATA_NAMES;
    ...
    public static final String OBS_SDK_VERSION = "3.19.5.3";
    ...
    public static final String USER_AGENT_VALUE = "obs-sdk-java/3.19.5.3";
    ...
    static {
        ...
        HEADERS_MAP = map;
        map.put(AuthTypeEnum.V2, V2Headers.getInstance());
        HEADERS_MAP.put(AuthTypeEnum.V4, V2Headers.getInstance());
        HEADERS_MAP.put(AuthTypeEnum.OBS, ObsHeaders.getInstance());
        HashMap map2 = new HashMap();
        CONVERTOR_MAP = map2;
        map2.put(AuthTypeEnum.V2, V2Convertor.getInstance());
        CONVERTOR_MAP.put(AuthTypeEnum.V4, V2Convertor.getInstance());
        CONVERTOR_MAP.put(AuthTypeEnum.OBS, ObsConvertor.getInstance());
        HashMap map3 = new HashMap();
        AUTHTICATION_MAP = map3;
        map3.put(AuthTypeEnum.V2, V2Authentication.getInstance());
        AUTHTICATION_MAP.put(AuthTypeEnum.OBS, ObsAuthentication.getInstance());
        GMT_TIMEZONE = TimeZone.getTimeZone("GMT");
        ALLOWED_RESPONSE_HTTP_HEADER_METADATA_NAMES = Collections.unmodifiableList(Arrays.asList("content-type", "content-md5", "content-length", "content-language", "expires", "origin", "cache-control", "content-disposition", "content-encoding", "x-default-storage-class", "location", "date", "etag", "host", "last-modified", "content-range", "x-reserved", "x-reserved-indicator", "access-control-allow-origin", "access-control-allow-headers", "access-control-max-age", "access-control-allow-methods", "access-control-expose-headers", "connection"));
        ALLOWED_REQUEST_HTTP_HEADER_METADATA_NAMES = Collections.unmodifiableList(Arrays.asList("content-type", "content-md5", "content-length", "content-language", "expires", "origin", "cache-control", "content-disposition", "content-encoding", "access-control-request-method", "access-control-request-headers", "success-action-redirect", "x-default-storage-class", "location", "date", "etag", "range", "host", "if-modified-since", "if-unmodified-since", "if-match", "if-none-match", "last-modified", "content-range", "x-cache-control"));
        ALLOWED_RESOURCE_PARAMTER_NAMES = Collections.unmodifiableList(Arrays.asList("acl", "backtosource", "policy", "torrent", "logging", "location", "storageinfo", "quota", "storagepolicy", "storageclass", "requestpayment", "versions", "versioning", "versionid", "uploads", "uploadid", "partnumber", "website", "notification", "lifecycle", "deletebucket", "delete", "cors", "restore", "tagging", "replication", "metadata", "encryption", "directcoldaccess", "append", "position", "truncate", "modify", "rename", "length", "name", "fileinterface", "readahead", "response-content-type", "response-content-language", "response-expires", "response-cache-control", "response-content-disposition", "response-content-encoding", "x-image-save-bucket", "x-image-save-object", "x-image-process", "x-obs-sse-kms-key-project-id", "x-oss-process"));
    }
}
