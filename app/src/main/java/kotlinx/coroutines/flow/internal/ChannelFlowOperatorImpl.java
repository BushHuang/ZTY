...
public final class ChannelFlowOperatorImpl<T> extends ChannelFlowOperator<T, T> {
    ...
    public ChannelFlowOperatorImpl(Flow flow, EmptyCoroutineContext emptyCoroutineContext, int i, BufferOverflow bufferOverflow, int i2, DefaultConstructorMarker defaultConstructorMarker) {
