...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    private final Object awaitValue(SharedFlowSlot sharedFlowSlot, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryPeekLocked(sharedFlowSlot) < 0) {
                ...
                cancellableContinuationImpl2.resumeWith(Result.m228constructorimpl(Unit.INSTANCE));
            }
    ...
    static Object collect$suspendImpl(SharedFlowImpl sharedFlowImpl, FlowCollector flowCollector, Continuation continuation) throws Throwable {
    ...
    static Object emit$suspendImpl(SharedFlowImpl sharedFlowImpl, Object obj, Continuation continuation) {
    ...
    private final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m228constructorimpl(Unit.INSTANCE));
            }
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long oldIndex) {
        ...
        long j7 = getNCollectors() == 0 ? bufferEndIndex : j;
        ...
        updateBufferLocked(jMax, j7, bufferEndIndex, j4);
        cleanupTailLocked();
