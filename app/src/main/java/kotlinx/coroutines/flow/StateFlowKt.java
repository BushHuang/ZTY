...
public final class StateFlowKt {
    ...
    public static final <T> Flow<T> fuseStateFlow(StateFlow<? extends T> stateFlow, CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow) {
        ...
        return (((i >= 0 && i < 2) || i == -2) && bufferOverflow == BufferOverflow.DROP_OLDEST) ? stateFlow : SharedFlowKt.fuseSharedFlow(stateFlow, coroutineContext, i, bufferOverflow);
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        C$r8$backportedMethods$utility$Long$1$hashCode c$r8$backportedMethods$utility$Long$1$hashCode;
        do {
            c$r8$backportedMethods$utility$Long$1$hashCode = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(c$r8$backportedMethods$utility$Long$1$hashCode, function1.invoke(c$r8$backportedMethods$utility$Long$1$hashCode)));
    }
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            c$r8$backportedMethods$utility$Long$1$hashCode = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(c$r8$backportedMethods$utility$Long$1$hashCode);
        } while (!mutableStateFlow.compareAndSet(c$r8$backportedMethods$utility$Long$1$hashCode, tInvoke));
        return tInvoke;
    }
}
