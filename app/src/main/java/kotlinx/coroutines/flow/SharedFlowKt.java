...
public final class SharedFlowKt {
    ...
    public static MutableSharedFlow MutableSharedFlow$default(int i, int i2, BufferOverflow bufferOverflow, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    private static final Object getBufferAt(Object[] objArr, long j) {
    ...
    private static final void setBufferAt(Object[] objArr, long j, Object obj) {
