...
final class FlowKt__LimitKt$take$2$1<T> implements FlowCollector, SuspendFunction {
    ...
    public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (this.$consumed.element < this.$count) {
            ...
            if (flowCollector.emit(t, flowKt__LimitKt$take$2$1$emit$1) == coroutine_suspended) {
        ...
        if (FlowKt__LimitKt.emitAbort$FlowKt__LimitKt(flowCollector2, t, flowKt__LimitKt$take$2$1$emit$1) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
