...
final class FlowKt__EmittersKt {
    ...
    public static final class AnonymousClass1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public static final class C00251<T> implements FlowCollector, SuspendFunction {
            final FlowCollector<R> $$this$flow;
            final Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> $transform;

            public C00251(Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, FlowCollector<? super R> flowCollector) {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$this_transform.collect(new C00251(this.$transform, flowCollector), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            FlowCollector flowCollector = (FlowCollector) this.L$0;
            InlineMarker.mark(0);
            this.$this_transform.collect(new C00251(this.$transform, flowCollector), this);
            InlineMarker.mark(1);
            return Unit.INSTANCE;
        }
    }
    ...
    private static final <T> Object invokeSafely$FlowKt__EmittersKt(FlowCollector<? super T> flowCollector, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3, Throwable th, Continuation<? super Unit> continuation) throws Throwable {
