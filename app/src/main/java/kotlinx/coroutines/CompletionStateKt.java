...
public final class CompletionStateKt {
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        ...
        return Result.m228constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame));
    }
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        return thM231exceptionOrNullimpl == null ? function1 != null ? new CompletedWithCancellation(obj, function1) : obj : new CompletedExceptionally(thM231exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (thM231exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    thM231exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM231exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(thM231exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
