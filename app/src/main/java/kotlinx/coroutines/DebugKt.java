...
public final class DebugKt {
    ...
    static {
        ...
        String strSystemProp = SystemPropsKt.systemProp("kotlinx.coroutines.debug");
        boolean z = false;
        if (strSystemProp == null) {
            ...
            if (iHashCode != 0) {
                if (iHashCode != 3551) {
                    ...
                    } else if (strSystemProp.equals("off")) {
                        assertions_enabled = false;
                    }
                }
                throw new IllegalStateException(("System property 'kotlinx.coroutines.debug' has unrecognized value '" + ((Object) strSystemProp) + '\'').toString());
            }
        }
    ...
    private static final void m1646assert(Function0<Boolean> function0) {
