...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        public static Object putImpl$default(Core core, Object obj, Object obj2, HashedWeakRef hashedWeakRef, int i, Object obj3) {
            if ((i & 4) != 0) {
                hashedWeakRef = null;
            }
            ...
            while (true) {
                ...
                while (i2 < i) {
                    ...
                    while (true) {
                        ...
                        if (this.values.compareAndSet(i2, obj, ConcurrentWeakMapKt.mark(obj))) {
                            break;
                        }
                    }
    ...
    public ConcurrentWeakMap(boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? false : z);
    }
    ...
    public Set<Map.Entry<K, V>> getEntries() {
        return new KeyValueSet(new Function2<K, V, Map.Entry<K, V>>() {
            @Override
    ...
    public Set<K> getKeys() {
        return new KeyValueSet(new Function2<K, V, K>() {
            @Override
