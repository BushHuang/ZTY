...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM228constructorimpl = Result.m228constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM228constructorimpl = Result.m228constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m234isFailureimpl(objM228constructorimpl) ? null : objM228constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() {
                public final void handle(Signal signal) {
                    AgentPremain.m1685installSignalHandler$lambda1(signal);
                }
            });
    ...
    private static final void m1685installSignalHandler$lambda1(Signal signal) {
