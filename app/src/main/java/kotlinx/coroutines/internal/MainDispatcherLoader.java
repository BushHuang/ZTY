...
public final class MainDispatcherLoader {
    ...
    private final MainCoroutineDispatcher loadMainDispatcher() {
        ...
        try {
            ...
            MainCoroutineDispatcher mainCoroutineDispatcherTryCreateDispatcher = mainDispatcherFactory == null ? null : MainDispatchersKt.tryCreateDispatcher(mainDispatcherFactory, listLoadMainDispatcherFactory$kotlinx_coroutines_core);
