...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM228constructorimpl = Result.m228constructorimpl(Class.forName("kotlin.coroutines.jvm.internal.BaseContinuationImpl").getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM228constructorimpl = Result.m228constructorimpl(ResultKt.createFailure(th));
        }
        baseContinuationImplClassName = (String) (Result.m231exceptionOrNullimpl(objM228constructorimpl) == null ? objM228constructorimpl : "kotlin.coroutines.jvm.internal.BaseContinuationImpl");
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM228constructorimpl2 = Result.m228constructorimpl(Class.forName("kotlinx.coroutines.internal.StackTraceRecoveryKt").getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM228constructorimpl2 = Result.m228constructorimpl(ResultKt.createFailure(th2));
        }
        stackTraceRecoveryClassName = (String) (Result.m231exceptionOrNullimpl(objM228constructorimpl2) == null ? objM228constructorimpl2 : "kotlinx.coroutines.internal.StackTraceRecoveryKt");
    }
