...
public final class ExceptionsConstructorKt {
    ...
    private static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> cls) {
        ...
        Iterator it = ArraysKt.sortedWith(cls.getConstructors(), new Comparator() {
            @Override
            ...
            return new Function1<Throwable, Throwable>() {
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        ...
                        objM228constructorimpl = Result.m228constructorimpl(ResultKt.createFailure(th2));
                    }
                    ...
                    th3.initCause(th);
                    objM228constructorimpl = Result.m228constructorimpl(th3);
                    if (Result.m234isFailureimpl(objM228constructorimpl)) {
                        objM228constructorimpl = null;
                    }
                    return (Throwable) objM228constructorimpl;
                }
            };
        }
        if (length != 1) {
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() {
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        objM228constructorimpl = Result.m228constructorimpl((Throwable) objNewInstance);
                        if (Result.m234isFailureimpl(objM228constructorimpl)) {
                            objM228constructorimpl = null;
                        }
                        return (Throwable) objM228constructorimpl;
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM228constructorimpl = Result.m228constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
        ...
        if (Result.m234isFailureimpl(objM228constructorimpl)) {
            objM228constructorimpl = numValueOf;
        }
        return ((Number) objM228constructorimpl).intValue();
    }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() {
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM228constructorimpl = Result.m228constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM228constructorimpl = Result.m228constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM228constructorimpl = Result.m228constructorimpl(((CopyableThrowable) e).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM228constructorimpl = Result.m228constructorimpl(ResultKt.createFailure(th));
        }
        ...
        return (E) objM228constructorimpl;
    }
}
