...
public final class LockFreeTaskQueueCore<E> {
    ...
    public final int addLast(E element) {
        while (true) {
            ...
            } else if (_state$FU.compareAndSet(this, j, INSTANCE.updateTail(j, (i2 + 1) & 1073741823))) {
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            ...
            C$r8$backportedMethods$utility$Long$1$hashCode c$r8$backportedMethods$utility$Long$1$hashCode = (Object) this.array.get(i3 & i);
            if (c$r8$backportedMethods$utility$Long$1$hashCode != null && !(c$r8$backportedMethods$utility$Long$1$hashCode instanceof Placeholder)) {
                arrayList.add(transform.invoke(c$r8$backportedMethods$utility$Long$1$hashCode));
            }
            i++;
        }
    }
