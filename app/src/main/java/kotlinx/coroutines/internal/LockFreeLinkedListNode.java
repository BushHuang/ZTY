...
public class LockFreeLinkedListNode {
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (retry(lockFreeLinkedListNodeTakeAffectedNode, obj)) {
                        ...
                        if (LockFreeLinkedListNode._next$FU.compareAndSet(lockFreeLinkedListNodeTakeAffectedNode, obj, prepareOp)) {
                            try {
                                ...
                                LockFreeLinkedListNode._next$FU.compareAndSet(lockFreeLinkedListNodeTakeAffectedNode, prepareOp, obj);
                                throw th;
                            }
                        } else {
                            continue;
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            if (objOnPrepare != LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                ...
                LockFreeLinkedListNode._next$FU.compareAndSet(lockFreeLinkedListNode, this, objDecide == AtomicKt.NO_DECISION ? getAtomicOp() : objDecide == null ? this.desc.updatedNext(lockFreeLinkedListNode, this.next) : this.next);
                return null;
            }
    ...
    public static final class AnonymousClass1 extends CondAddOp {
        ...
        public AnonymousClass1(Function0<Boolean> function0) {
    ...
    public final boolean addLastIf(LockFreeLinkedListNode node, Function0<Boolean> condition) {
        int iTryCondAddNext;
        AnonymousClass1 anonymousClass1 = node.new AnonymousClass1(condition);
        do {
    ...
    public final CondAddOp makeCondAddOp(LockFreeLinkedListNode node, Function0<Boolean> condition) {
        return node.new AnonymousClass1(condition);
    }
    ...
    public final <T> T removeFirstIfIsInstanceOfOrPeekIf(Function1<? super T, Boolean> predicate) {
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo1708remove()) {
                return lockFreeLinkedListNode;
            }
