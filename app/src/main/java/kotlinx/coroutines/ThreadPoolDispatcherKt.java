...
public final class ThreadPoolDispatcherKt {
        ...
        if (i >= 1) {
            ...
            return ExecutorsKt.from((ExecutorService) Executors.newScheduledThreadPool(i, new ThreadFactory() {
                ...
                public final Thread newThread(Runnable runnable) {
                    return ThreadPoolDispatcherKt.m1655newFixedThreadPoolContext$lambda1(i, str, atomicInteger, runnable);
                }
            }));
        }
    ...
    private static final Thread m1655newFixedThreadPoolContext$lambda1(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        if (i != 1) {
