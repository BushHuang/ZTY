        ...
        try {
            ...
            try {
                ...
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    continuationProbeCoroutineCreated.resumeWith(Result.m228constructorimpl(objInvoke));
                }
            } finally {
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m228constructorimpl(ResultKt.createFailure(th)));
        }
    }
