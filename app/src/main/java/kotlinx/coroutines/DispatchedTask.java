...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        try {
            ...
            UndispatchedCoroutine<?> undispatchedCoroutineUpdateUndispatchedCompletion = objUpdateThreadContext != ThreadContextKt.NO_THREAD_ELEMENTS ? CoroutineContextKt.updateUndispatchedCompletion(continuation, context, objUpdateThreadContext) : (UndispatchedCoroutine) null;
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m228constructorimpl(ResultKt.createFailure((DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) ? StackTraceRecoveryKt.recoverFromStackFrame(cancellationException, (CoroutineStackFrame) continuation) : cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m228constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    ...
                    continuation.resumeWith(Result.m228constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    objM228constructorimpl2 = Result.m228constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM228constructorimpl2 = Result.m228constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m231exceptionOrNullimpl(objM228constructorimpl2));
            } finally {
            ...
            try {
                ...
                objM228constructorimpl = Result.m228constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m231exceptionOrNullimpl(objM228constructorimpl));
        }
    }
