...
public final class SelectInstance<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, kotlinx.coroutines.selects.SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private static final AtomicReferenceFieldUpdater _result$FU = AtomicReferenceFieldUpdater.newUpdater(SelectInstance.class, Object.class, "_result");

    volatile Object state = SelectKt.getNOT_SELECTED();

    private volatile Object result = SelectKt.UNDECIDED;
    ...
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            SelectInstance._state$FU.compareAndSet(selectInstance, this, objDecide == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
            return objDecide;
        }
    }
    ...
    private final void doAfterSelect() {
        ...
        for (LockFreeLinkedListNode nextNode = (LockFreeLinkedListNode) selectInstance.getNext(); !Intrinsics.areEqual(nextNode, selectInstance); nextNode = nextNode.getNextNode()) {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m228constructorimpl(ResultKt.createFailure(e)));
        } else {
    ...
    public void onTimeout(long timeMillis, final Function1<? super Continuation<? super R>, ? extends Object> block) {
        if (timeMillis > 0) {
            disposeOnSelect(DelayKt.getDelay(getContext()).invokeOnTimeout(timeMillis, new Runnable() {
                @Override
    ...
    public void resumeSelectWithException(Throwable exception) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                Continuation<R> continuation = this.uCont;
                if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, new CompletedExceptionally((DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) ? StackTraceRecoveryKt.recoverFromStackFrame(exception, (CoroutineStackFrame) continuation) : exception, false, 2, null))) {
                    return;
                }
            } else {
                if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                ...
                if (_result$FU.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuationIntercepted.resumeWith(Result.m228constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        }
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            Object obj = this.result;
            if (obj == SelectKt.UNDECIDED) {
                if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(result, null, 1, null))) {
                    return;
                }
            } else {
                if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                ...
                if (_result$FU.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    ...
                    Continuation<R> continuation = this.uCont;
                    Throwable thM231exceptionOrNullimpl = Result.m231exceptionOrNullimpl(result);
                    Intrinsics.checkNotNull(thM231exceptionOrNullimpl);
                    Result.Companion companion = Result.INSTANCE;
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        thM231exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM231exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                    }
                    continuation.resumeWith(Result.m228constructorimpl(ResultKt.createFailure(thM231exceptionOrNullimpl)));
                    return;
                }
            }
        }
    ...
    public boolean trySelect() {
        ...
        throw new IllegalStateException(Intrinsics.stringPlus("Unexpected trySelectIdempotent result ", objTrySelectOther).toString());
    }
    ...
    public Object trySelectOther(LockFreeLinkedListNode.PrepareOp otherOp) {
        while (true) {
            ...
            if (obj == SelectKt.getNOT_SELECTED()) {
                ...
                } else if (_state$FU.compareAndSet(this, SelectKt.getNOT_SELECTED(), null)) {
                    break;
                }
            } else {
                if (!(obj instanceof OpDescriptor)) {
