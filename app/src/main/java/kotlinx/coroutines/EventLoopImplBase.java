...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    protected long getNextTime() {
        ...
        AbstractTimeSource timeSource = AbstractTimeSourceKt.getTimeSource();
        Long lValueOf = timeSource != null ? Long.valueOf(timeSource.nanoTime()) : null;
        return RangesKt.coerceAtLeast(j - (lValueOf == null ? System.nanoTime() : lValueOf.longValue()), 0L);
    }
        ...
        if (delayedTaskQueue != null && !delayedTaskQueue.isEmpty()) {
            ...
            do {
                ...
                synchronized (delayedTaskQueue2) {
                    ...
                    if (delayedTaskFirstImpl == null) {
                        objRemoveAtImpl = null;
                    } else {
                        DelayedTask delayedTask = delayedTaskFirstImpl;
                        objRemoveAtImpl = delayedTask.timeToExecute(jNanoTime) ? enqueueImpl(delayedTask) : false ? delayedTaskQueue2.removeAtImpl(0) : (ThreadSafeHeapNode) null;
                    }
                }
            } while (((DelayedTask) objRemoveAtImpl) != null);
        }
