...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM228constructorimpl = Result.m228constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM228constructorimpl = Result.m228constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m234isFailureimpl(objM228constructorimpl) ? null : objM228constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1709dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() {
            @Override
    ...
    public static HandlerDispatcher from$default(Handler handler, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = null;
        }
    ...
    private static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() {
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1659postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }

    private static final void m1659postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
