...
public final class ChannelKt {
    ...
    public static final Channel Channel(int i) {
    ...
    public static final <E> Channel<E> Channel(int i, BufferOverflow bufferOverflow, Function1<? super E, Unit> function1) {
        ...
        if (i != Integer.MAX_VALUE) {
            return (i == 1 && bufferOverflow == BufferOverflow.DROP_OLDEST) ? new ConflatedChannel(function1) : new ArrayChannel(i, bufferOverflow, function1);
        }
        return new LinkedListChannel(function1);
    }

    public static Channel Channel$default(int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return Channel(i);
    ...
    public static final <T> T m1664getOrElseWpGqRn0(Object obj, Function1<? super Throwable, ? extends T> function1) {
        return obj instanceof ChannelResult.Failed ? function1.invoke(ChannelResult.m1672exceptionOrNullimpl(obj)) : obj;
    }

    public static final <T> Object m1665onClosedWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m1672exceptionOrNullimpl(obj));
        }
        return obj;
    }

    public static final <T> Object m1666onFailureWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
    ...
    public static final <T> Object m1667onSuccessWpGqRn0(Object obj, Function1<? super T, Unit> function1) {
        if (!(obj instanceof ChannelResult.Failed)) {
