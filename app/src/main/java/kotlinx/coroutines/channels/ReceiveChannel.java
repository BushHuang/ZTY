...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        public static void cancel$default(ReceiveChannel receiveChannel, CancellationException cancellationException, int i, Object obj) {
            if (obj != null) {
        ...
        public static boolean cancel$default(ReceiveChannel receiveChannel, Throwable th, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: cancel");
            }
            if ((i & 1) != 0) {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1662tryReceivePtdJZtk = receiveChannel.mo1662tryReceivePtdJZtk();
            if (ChannelResult.m1678isSuccessimpl(objMo1662tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1674getOrThrowimpl(objMo1662tryReceivePtdJZtk);
            }
            Throwable thM1672exceptionOrNullimpl = ChannelResult.m1672exceptionOrNullimpl(objMo1662tryReceivePtdJZtk);
            if (thM1672exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1672exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo1661receiveCatchingJP2dKIU = receiveChannel.mo1661receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m1673getOrNullimpl(objMo1661receiveCatchingJP2dKIU);
        }
    }
    ...
    Object mo1661receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    Object mo1662tryReceivePtdJZtk();
}
