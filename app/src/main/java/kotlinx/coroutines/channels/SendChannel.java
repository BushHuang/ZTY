...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        public static boolean close$default(SendChannel sendChannel, Throwable th, int i, Object obj) {
            if (obj != null) {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1678isSuccessimpl(objMo1663trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1672exceptionOrNullimpl = ChannelResult.m1672exceptionOrNullimpl(objMo1663trySendJP2dKIU);
    ...
    Object mo1663trySendJP2dKIU(E element);
}
