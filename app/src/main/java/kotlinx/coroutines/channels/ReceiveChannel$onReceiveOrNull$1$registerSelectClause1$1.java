...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public Object invoke(Object obj, Object obj2) {
        return m1684invokeWpGqRn0(((ChannelResult) obj).getHolder(), (Continuation) obj2);
    }

    public final Object m1684invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1668boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            Object objM1673getOrNullimpl = ChannelResult.m1673getOrNullimpl(holder);
            this.label = 1;
            obj = function2.invoke(objM1673getOrNullimpl, this);
