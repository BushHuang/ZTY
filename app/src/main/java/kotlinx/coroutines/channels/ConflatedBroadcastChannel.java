...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public Object mo1663trySendJP2dKIU(E element) {
        Closed closedOfferInternal = offerInternal(element);
        return closedOfferInternal == null ? ChannelResult.INSTANCE.m1683successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1681closedJP2dKIU(closedOfferInternal.getSendException());
    }
}
