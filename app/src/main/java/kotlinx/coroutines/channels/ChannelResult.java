...
public final class ChannelResult<T> {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1681closedJP2dKIU(Throwable cause) {
            return ChannelResult.m1669constructorimpl(new Closed(cause));
        }

        public final <E> Object m1682failurePtdJZtk() {
            return ChannelResult.m1669constructorimpl(ChannelResult.failed);
        }

        public final <E> Object m1683successJP2dKIU(E value) {
            return ChannelResult.m1669constructorimpl(value);
        }
    }
    ...
    private ChannelResult(Object obj) {
        this.holder = obj;
    }

    public static final ChannelResult m1668boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    public static <T> Object m1669constructorimpl(Object obj) {
        return obj;
    }

    public static boolean m1670equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    public static final boolean m1671equalsimpl0(Object obj, Object obj2) {
        return Intrinsics.areEqual(obj, obj2);
    }

    public static final Throwable m1672exceptionOrNullimpl(Object obj) {
    ...
    public static final T m1673getOrNullimpl(Object obj) {
    ...
    public static final T m1674getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static int m1675hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m1676isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    public static final boolean m1677isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    public static final boolean m1678isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }
    ...
    public boolean equals(Object obj) {
        return m1670equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1675hashCodeimpl(this.holder);
    }
