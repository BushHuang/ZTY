...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    private static final class Itr<E> implements ChannelIterator<E> {
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m228constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m228constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
                    ...
                    cancellableContinuationImpl.resume(boolBoxBoolean, function1 == null ? null : OnUndeliveredElementKt.bindCancellationFun(function1, objPollInternal, cancellableContinuationImpl.getContext()));
                }
            }
        ...
        public Object next(Continuation continuation) {
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m228constructorimpl(ChannelResult.m1668boximpl(ChannelResult.INSTANCE.m1681closedJP2dKIU(closed.closeCause))));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m228constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            }
        }

        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1668boximpl(ChannelResult.INSTANCE.m1683successJP2dKIU(value)) : value;
        }
        ...
        public Symbol tryResumeReceive(E value, LockFreeLinkedListNode.PrepareOp otherOp) {
            Object objTryResume = this.cont.tryResume(resumeValue(value), otherOp == null ? null : otherOp.desc, resumeOnCancellationFun(value));
    ...
    private static class ReceiveHasNext<E> extends Receive<E> {
        ...
        @Override
        public void resumeReceiveClosed(Closed<?> closed) {
            Object objTryResume$default = closed.closeCause == null ? CancellableContinuation.DefaultImpls.tryResume$default(this.cont, false, null, 2, null) : this.cont.tryResumeWithException(closed.getReceiveException());
        ...
        @Override
        public Symbol tryResumeReceive(E value, LockFreeLinkedListNode.PrepareOp otherOp) {
            Object objTryResume = this.cont.tryResume(true, otherOp == null ? null : otherOp.desc, resumeOnCancellationFun(value));
            if (objTryResume == null) {
                return null;
            }
            if (DebugKt.getASSERTIONS_ENABLED()) {
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1668boximpl(ChannelResult.INSTANCE.m1683successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) throws Throwable {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1668boximpl(ChannelResult.INSTANCE.m1681closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    private final <R> Object receiveSuspend(int i, Continuation<? super R> continuation) {
        CancellableContinuationImpl orCreateCancellableContinuation = CancellableContinuationKt.getOrCreateCancellableContinuation(IntrinsicsKt.intercepted(continuation));
        CancellableContinuationImpl cancellableContinuationImpl = orCreateCancellableContinuation;
        ReceiveElement receiveElement = this.onUndeliveredElement == null ? new ReceiveElement(cancellableContinuationImpl, i) : new ReceiveElementWithUndeliveredHandler(cancellableContinuationImpl, i, this.onUndeliveredElement);
        while (true) {
            ...
            if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                cancellableContinuationImpl.resume(receiveElement.resumeValue(objPollInternal), receiveElement.resumeOnCancellationFun(objPollInternal));
                break;
            }
        }
        Object result = orCreateCancellableContinuation.getResult();
    ...
    private final <R> void registerSelectReceiveMode(SelectInstance<? super R> select, int receiveMode, Function2<Object, ? super Continuation<? super R>, ? extends Object> block) throws Throwable {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) throws Throwable {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1668boximpl(z ? companion.m1681closedJP2dKIU(((Closed) obj).closeCause) : companion.m1683successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1668boximpl(ChannelResult.INSTANCE.m1681closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
    ...
    protected boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        if (!isBufferAlwaysEmpty()) {
            ...
            do {
                ...
                iTryCondAddNext = prevNode2.tryCondAddNext(receive2, queue, condAddOp);
    ...
    public final SelectClause1<E> getOnReceive() {
        return new SelectClause1<E>(this) {
    ...
    public final SelectClause1<ChannelResult<E>> getOnReceiveCatching() {
        return new SelectClause1<ChannelResult<? extends E>>(this) {
            final AbstractChannel<E> this$0;
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        while (true) {
            ...
            if (prevNode instanceof LockFreeLinkedListHead) {
                mo1660onCancelIdempotentListww6eGU(objM1700constructorimpl$default, closedForSend);
                return;
            } else {
                if (DebugKt.getASSERTIONS_ENABLED() && !(prevNode instanceof Send)) {
                    throw new AssertionError();
                }
                if (prevNode.mo1708remove()) {
                    objM1700constructorimpl$default = InlineList.m1705plusFjFbRPM(objM1700constructorimpl$default, (Send) prevNode);
                } else {
                    prevNode.helpRemove();
                }
            }
    ...
    protected void mo1660onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    @Override
    public final Object mo1661receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (i == 0) {
            ...
            Object objPollInternal = pollInternal();
            if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m1681closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m1683successJP2dKIU(objPollInternal);
            }
    ...
    @Override
    public final Object mo1662tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        return objPollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1682failurePtdJZtk() : objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m1681closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m1683successJP2dKIU(objPollInternal);
    }
}
