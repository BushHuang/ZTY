        ...
        if (list != null) {
            if (!(list instanceof ArrayList)) {
                ...
                if (send instanceof AbstractSendChannel.SendBuffered) {
                    ...
                    if (function1 != null) {
                        undeliveredElementExceptionCallUndeliveredElementCatchingException = OnUndeliveredElementKt.callUndeliveredElementCatchingException(function1, ((AbstractSendChannel.SendBuffered) send).element, (UndeliveredElementException) null);
                    }
                } else {
                ...
                if (size >= 0) {
                    ...
                    while (true) {
                        ...
                        if (send2 instanceof AbstractSendChannel.SendBuffered) {
                            ...
                            undeliveredElementExceptionCallUndeliveredElementCatchingException2 = function12 == null ? null : OnUndeliveredElementKt.callUndeliveredElementCatchingException(function12, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementExceptionCallUndeliveredElementCatchingException2);
                        } else {
