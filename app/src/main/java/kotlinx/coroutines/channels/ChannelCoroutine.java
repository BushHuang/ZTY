...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    @Override
    public Object mo1661receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1661receiveCatchingJP2dKIU(continuation);
    ...
    @Override
    public Object mo1662tryReceivePtdJZtk() {
        return this._channel.mo1662tryReceivePtdJZtk();
    }

    @Override
    public Object mo1663trySendJP2dKIU(E element) {
        return this._channel.mo1663trySendJP2dKIU(element);
    }
}
