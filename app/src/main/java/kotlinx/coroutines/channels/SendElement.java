...
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m228constructorimpl(ResultKt.createFailure(closed.getSendException())));
    }
    ...
    public Symbol tryResumeSend(LockFreeLinkedListNode.PrepareOp otherOp) {
        Object objTryResume = this.cont.tryResume(Unit.INSTANCE, otherOp == null ? null : otherOp.desc);
