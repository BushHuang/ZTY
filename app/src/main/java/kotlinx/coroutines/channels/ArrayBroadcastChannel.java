...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    @Override
    private final boolean cancel(Throwable cause) {
        ...
        while (true) {
            ...
            while (j2 < jCoerceAtMost) {
                ...
                if (z) {
                    ...
                    this.buffer[(int) (j % getCapacity())] = sendTakeFirstSendOrPeekClosed.getElement();
                    setSize(i + 1);
                    setTail(j + 1);
                    Unit unit = Unit.INSTANCE;
                    reentrantLock.unlock();
    ...
    static void updateHead$default(ArrayBroadcastChannel arrayBroadcastChannel, Subscriber subscriber, Subscriber subscriber2, int i, Object obj) {
        if ((i & 1) != 0) {
            subscriber = null;
        }
        if ((i & 2) != 0) {
