...
public final class CoroutineScopeKt {
    ...
    public static void cancel$default(CoroutineScope coroutineScope, String str, Throwable th, int i, Object obj) {
        if ((i & 2) != 0) {
            th = null;
        }
    ...
    public static void cancel$default(CoroutineScope coroutineScope, CancellationException cancellationException, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public static void isActive$annotations(CoroutineScope coroutineScope) {
    }
