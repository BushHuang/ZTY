...
public final class TestCoroutineContext implements CoroutineContext {
    ...
    private final class Dispatcher extends EventLoop implements Delay {
        ...
        public DisposableHandle invokeOnTimeout(long timeMillis, Runnable block, CoroutineContext context) {
            final TimedRunnable timedRunnablePostDelayed = TestCoroutineContext.this.postDelayed(block, timeMillis);
            final TestCoroutineContext testCoroutineContext = TestCoroutineContext.this;
            return new DisposableHandle() {
                @Override
                public void dispose() {
                    testCoroutineContext.queue.remove(timedRunnablePostDelayed);
                }
            };
        }
        ...
        @Override
        public void mo1710scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
            TestCoroutineContext.this.postDelayed(new Runnable() {
                @Override
    ...
    public static long advanceTimeBy$default(TestCoroutineContext testCoroutineContext, long j, TimeUnit timeUnit, int i, Object obj) {
        if ((i & 2) != 0) {
    ...
    public static void advanceTimeTo$default(TestCoroutineContext testCoroutineContext, long j, TimeUnit timeUnit, int i, Object obj) {
        if ((i & 2) != 0) {
            timeUnit = TimeUnit.MILLISECONDS;
        }
    ...
    public static void assertAllUnhandledExceptions$default(TestCoroutineContext testCoroutineContext, String str, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            str = "";
        }
    ...
    public static void assertAnyUnhandledException$default(TestCoroutineContext testCoroutineContext, String str, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            str = "";
        }
    ...
    public static void assertExceptions$default(TestCoroutineContext testCoroutineContext, String str, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            str = "";
        }
    ...
    public static void assertUnhandledException$default(TestCoroutineContext testCoroutineContext, String str, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
            str = "";
        }
    ...
    public static long now$default(TestCoroutineContext testCoroutineContext, TimeUnit timeUnit, int i, Object obj) {
        if ((i & 1) != 0) {
            timeUnit = TimeUnit.MILLISECONDS;
        }
    ...
    private final void triggerActions(long targetTime) {
        ...
        while (true) {
            ...
            synchronized (threadSafeHeap) {
                ThreadSafeHeapNode threadSafeHeapNodeFirstImpl = threadSafeHeap.firstImpl();
                threadSafeHeapNodeRemoveAtImpl = null;
                if (threadSafeHeapNodeFirstImpl != null) {
                    threadSafeHeapNodeRemoveAtImpl = (((TimedRunnable) threadSafeHeapNodeFirstImpl).time > targetTime ? 1 : (((TimedRunnable) threadSafeHeapNodeFirstImpl).time == targetTime ? 0 : -1)) <= 0 ? threadSafeHeap.removeAtImpl(0) : (ThreadSafeHeapNode) null;
                }
            }
            TimedRunnable timedRunnable = (TimedRunnable) threadSafeHeapNodeRemoveAtImpl;
            if (timedRunnable == null) {
                return;
            }
