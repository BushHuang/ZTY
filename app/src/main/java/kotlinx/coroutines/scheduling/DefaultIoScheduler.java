...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher default = UnlimitedIoScheduler.INSTANCE.limitedParallelism(SystemPropsKt__SystemProps_commonKt.systemProp$default("kotlinx.coroutines.io.parallelism", RangesKt.coerceAtLeast(64, SystemPropsKt.getAVAILABLE_PROCESSORS()), 0, 0, 12, (Object) null));
    ...
    public void mo1709dispatch(CoroutineContext context, Runnable block) {
        default.mo1709dispatch(context, block);
    }
    ...
    public void execute(Runnable command) {
        mo1709dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
