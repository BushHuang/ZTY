...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final boolean addLastAtomic(final Object expect, NodeList list, JobNode node) {
        ...
        LockFreeLinkedListNode.CondAddOp condAddOp = new LockFreeLinkedListNode.CondAddOp(this, expect) {
    ...
    public static JobCancellationException defaultCancellationException$kotlinx_coroutines_core$default(JobSupport jobSupport, String str, Throwable th, int i, Object obj) {
        if (obj != null) {
    ...
    private final Object finalizeFinishingState(Finishing state, Object proposedUpdate) throws Throwable {
        ...
        boolean zCompareAndSet = _state$FU.compareAndSet(this, state, JobSupportKt.boxIncomplete(proposedUpdate));
    ...
    private final <T extends JobNode> void notifyHandlers(NodeList list, Throwable cause) throws Throwable {
    ...
    public boolean cancel(Throwable cause) throws Throwable {
        JobCancellationException cancellationException$default = cause == null ? null : toCancellationException$default(this, cause, null, 1, null);
    ...
    public final DisposableHandle invokeOnCompletion(boolean onCancelling, boolean invokeImmediately, Function1<? super Throwable, Unit> handler) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                } else if (_state$FU.compareAndSet(this, state$kotlinx_coroutines_core, jobNodeMakeNode)) {
