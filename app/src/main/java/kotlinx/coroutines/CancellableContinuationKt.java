...
public final class CancellableContinuationKt {
    ...
    public static final <T> CancellableContinuationImpl<T> getOrCreateCancellableContinuation(Continuation<? super T> continuation) {
        ...
        if (cancellableContinuationImplClaimReusableCancellableContinuation == null || !cancellableContinuationImplClaimReusableCancellableContinuation.resetStateReusable()) {
            cancellableContinuationImplClaimReusableCancellableContinuation = null;
        }
        return cancellableContinuationImplClaimReusableCancellableContinuation == null ? new CancellableContinuationImpl<>(continuation, 2) : cancellableContinuationImplClaimReusableCancellableContinuation;
    }
