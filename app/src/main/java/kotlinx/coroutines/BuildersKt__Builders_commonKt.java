...
final class BuildersKt__Builders_commonKt {
    ...
    public static final <T> Object withContext(CoroutineContext coroutineContext, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        } else if (Intrinsics.areEqual(coroutineContextPlus.get(ContinuationInterceptor.INSTANCE), context.get(ContinuationInterceptor.INSTANCE))) {
            UndispatchedCoroutine undispatchedCoroutine = new UndispatchedCoroutine(coroutineContextPlus, continuation);
            Object objUpdateThreadContext = ThreadContextKt.updateThreadContext(coroutineContextPlus, null);
            try {
                ...
                ThreadContextKt.restoreThreadContext(coroutineContextPlus, objUpdateThreadContext);
