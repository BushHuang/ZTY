...
public interface Delay {
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(Delay delay, long j, Continuation<? super Unit> continuation) {
            ...
            delay.mo1710scheduleResumeAfterDelay(j, cancellableContinuationImpl);
    ...
    void mo1710scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation);
}
