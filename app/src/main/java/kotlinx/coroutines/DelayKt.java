...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1710scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1647delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1648toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1648toDelayMillisLRDsOJo(long j) {
        if (Duration.m1510compareToLRDsOJo(j, Duration.INSTANCE.m1613getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1529getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
