...
public class IOUtils {
    ...
    public static long skip(InputStream inputStream, long j) throws IOException {
        ...
        long j2 = j;
        while (j2 > 0) {
            long j3 = inputStream.read(SKIP_BYTE_BUFFER, 0, (int) Math.min(j2, 2048L));
            if (j3 < 0) {
                break;
            }
            j2 -= j3;
    ...
    public static long skip(Reader reader, long j) throws IOException {
        ...
        long j2 = j;
        while (j2 > 0) {
            long j3 = reader.read(SKIP_CHAR_BUFFER, 0, (int) Math.min(j2, 2048L));
            if (j3 < 0) {
                break;
            }
            j2 -= j3;
    ...
    public static String toString(URL url, String str) throws IOException {
        ...
        try {
            return toString(inputStreamOpenStream, str);
        } finally {
