...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public final R runCallLoop() throws Throwable {
        while (true) {
            ...
            if (Result.m230equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
                    Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> function3 = this.function;
                    Object objInvoke = ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function3, 3)).invoke(this, this.value, continuation);
                    if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        Result.Companion companion = Result.INSTANCE;
                        continuation.resumeWith(Result.m228constructorimpl(objInvoke));
                    }
                } catch (Throwable th) {
