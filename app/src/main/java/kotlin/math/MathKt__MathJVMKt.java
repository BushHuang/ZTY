...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    public static final double atanh(double d) {
        ...
        Double.isNaN(d3);
        Double.isNaN(d3);
        double dLog = Math.log((d3 + d) / (d3 - d));
        double d4 = 2;
        Double.isNaN(d4);
        return dLog / d4;
    }
    ...
    public static void getAbsoluteValue$annotations(long j) {
    }
    ...
    public static void getSign$annotations(long j) {
    }
