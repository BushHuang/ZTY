...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    private static final class Iterator extends UByteIterator {
        ...
        @Override
        public byte mo313nextUBytew2LRezQ() {
            int i = this.index;
    ...
    public static final UByteArray m296boximpl(byte[] bArr) {
        return new UByteArray(bArr);
    }

    public static byte[] m297constructorimpl(int i) {
        return m298constructorimpl(new byte[i]);
    }

    public static byte[] m298constructorimpl(byte[] bArr) {
        Intrinsics.checkNotNullParameter(bArr, "storage");
        return bArr;
    }

    public static boolean m299contains7apg3OU(byte[] bArr, byte b) {
        return ArraysKt.contains(bArr, b);
    }

    public static boolean m300containsAllimpl(byte[] bArr, Collection<UByte> collection) {
    ...
    public static boolean m301equalsimpl(byte[] bArr, Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual(bArr, ((UByteArray) obj).getStorage());
    }

    public static final boolean m302equalsimpl0(byte[] bArr, byte[] bArr2) {
        return Intrinsics.areEqual(bArr, bArr2);
    }

    public static final byte m303getw2LRezQ(byte[] bArr, int i) {
        return UByte.m246constructorimpl(bArr[i]);
    }

    public static int m304getSizeimpl(byte[] bArr) {
        return bArr.length;
    }
    ...
    public static int m305hashCodeimpl(byte[] bArr) {
        return Arrays.hashCode(bArr);
    }

    public static boolean m306isEmptyimpl(byte[] bArr) {
        return bArr.length == 0;
    }

    public static java.util.Iterator<UByte> m307iteratorimpl(byte[] bArr) {
        return new Iterator(bArr);
    }

    public static final void m308setVurrAj0(byte[] bArr, int i, byte b) {
        bArr[i] = b;
    }

    public static String m309toStringimpl(byte[] bArr) {
    ...
    public boolean m310add7apg3OU(byte b) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m311contains7apg3OU(((UByte) obj).getData());
        }
        return false;
    }

    public boolean m311contains7apg3OU(byte b) {
        return m299contains7apg3OU(this.storage, b);
    }
