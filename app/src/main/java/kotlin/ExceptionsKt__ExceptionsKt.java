...
class ExceptionsKt__ExceptionsKt {
    public static final void addSuppressed(Throwable th, Throwable th2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public static void getStackTrace$annotations(Throwable th) {
    }
    ...
    public static void getSuppressedExceptions$annotations(Throwable th) {
    }
