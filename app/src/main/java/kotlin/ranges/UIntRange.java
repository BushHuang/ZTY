...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public boolean contains(Comparable comparable) {
        return m1436containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    public boolean m1436containsWZ4Q5Ns(int value) {
    ...
    public Comparable getEndInclusive() {
        return UInt.m316boximpl(m1437getEndInclusivepVg5ArA());
    }

    public int m1437getEndInclusivepVg5ArA() {
        return getLast();
    }

    @Override
    public Comparable getStart() {
        return UInt.m316boximpl(m1438getStartpVg5ArA());
    }

    public int m1438getStartpVg5ArA() {
        return getFirst();
    }
    ...
    public String toString() {
        return ((Object) UInt.m367toStringimpl(getFirst())) + ".." + ((Object) UInt.m367toStringimpl(getLast()));
    }
}
