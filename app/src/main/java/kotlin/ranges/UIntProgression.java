...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1435fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1419getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public boolean isEmpty() {
        ...
        } else if (UnsignedKt.uintCompare(getFirst(), getLast()) < 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m367toStringimpl(getFirst()));
            sb.append("..");
            sb.append((Object) UInt.m367toStringimpl(getLast()));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
