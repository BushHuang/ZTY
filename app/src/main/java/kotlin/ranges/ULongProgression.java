...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1441fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1418getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        int iM400constructorimpl = ((((int) ULong.m400constructorimpl(getFirst() ^ ULong.m400constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m400constructorimpl(getLast() ^ ULong.m400constructorimpl(getLast() >>> 32)))) * 31;
        long j = this.step;
        return ((int) (j ^ (j >>> 32))) + iM400constructorimpl;
    }

    public boolean isEmpty() {
        long j = this.step;
        int iUlongCompare = UnsignedKt.ulongCompare(getFirst(), getLast());
        if (j > 0) {
            if (iUlongCompare > 0) {
                return true;
            }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m445toStringimpl(getFirst()));
            sb.append("..");
            sb.append((Object) ULong.m445toStringimpl(getLast()));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
