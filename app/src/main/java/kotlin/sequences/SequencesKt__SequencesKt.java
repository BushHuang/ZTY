...
class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class AnonymousClass1<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super AnonymousClass1> continuation) {
    ...
    static final class AnonymousClass1<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
        ...
        @Override
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$this_ifEmpty, this.$defaultValue, continuation);
            anonymousClass1.L$0 = obj;
            return anonymousClass1;
        }
    ...
    static final class AnonymousClass1<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(Sequence<? extends T> sequence, Random random, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
        ...
        @Override
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$this_shuffled, this.$random, continuation);
            anonymousClass1.L$0 = obj;
            return anonymousClass1;
        }
    ...
    public static final <T> Sequence<T> asSequence(final Iterator<? extends T> it) {
        ...
        return SequencesKt.constrainOnce(new Sequence<T>() {
            @Override
            public Iterator<T> iterator() {
                return it;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1) {
        ...
        return SequencesKt.sequence(new AnonymousClass1(sequence, function2, function1, null));
    }

    public static final <T> Sequence<T> flatten(Sequence<? extends Sequence<? extends T>> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return flatten$SequencesKt__SequencesKt(sequence, new Function1<Sequence<? extends T>, Iterator<? extends T>>() {
            @Override
    ...
    private static final <T, R> Sequence<R> flatten$SequencesKt__SequencesKt(Sequence<? extends T> sequence, Function1<? super T, ? extends Iterator<? extends R>> function1) {
        return sequence instanceof TransformingSequence ? ((TransformingSequence) sequence).flatten$kotlin_stdlib(function1) : new FlatteningSequence(sequence, new Function1<T, T>() {
            @Override
    ...
    public static final <T> Sequence<T> flattenSequenceOfIterable(Sequence<? extends Iterable<? extends T>> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return flatten$SequencesKt__SequencesKt(sequence, new Function1<Iterable<? extends T>, Iterator<? extends T>>() {
            @Override
    ...
    public static final <T> Sequence<T> generateSequence(final T t, Function1<? super T, ? extends T> function1) {
        ...
        return t == null ? EmptySequence.INSTANCE : new GeneratorSequence(new Function0<T>() {
            {
                super(0);
            }
    ...
    public static final <T> Sequence<T> generateSequence(final Function0<? extends T> function0) {
        ...
        return SequencesKt.constrainOnce(new GeneratorSequence(function0, new Function1<T, T>() {
            {
                super(1);
            }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0) {
        ...
        return SequencesKt.sequence(new AnonymousClass1(sequence, function0, null));
    }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new AnonymousClass1(sequence, random, null));
    }
