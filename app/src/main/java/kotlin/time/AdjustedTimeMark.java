...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1504elapsedNowUwyO8pc() {
        return Duration.m1546minusLRDsOJo(this.mark.mo1504elapsedNowUwyO8pc(), getAdjustment());
    }
    ...
    public TimeMark mo1505plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1547plusLRDsOJo(getAdjustment(), duration), null);
    }
}
