...
public abstract class TimeMark {
    public abstract long mo1504elapsedNowUwyO8pc();

    public final boolean hasNotPassedNow() {
        return Duration.m1544isNegativeimpl(mo1504elapsedNowUwyO8pc());
    }
    ...
    public TimeMark m1640minusLRDsOJo(long duration) {
        return mo1505plusLRDsOJo(Duration.m1563unaryMinusUwyO8pc(duration));
    }
