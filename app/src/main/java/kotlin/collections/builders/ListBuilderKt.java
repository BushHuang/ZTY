...
public final class ListBuilderKt {
    ...
    private static final <T> boolean subarrayContentEquals(T[] tArr, int i, int i2, List<?> list) {
        if (i2 != list.size()) {
            return false;
        }
    ...
    private static final <T> int subarrayContentHashCode(T[] tArr, int i, int i2) {
        int iHashCode = 1;
        for (int i3 = 0; i3 < i2; i3++) {
            T t = tArr[i + i3];
    ...
    private static final <T> String subarrayContentToString(T[] tArr, int i, int i2) {
