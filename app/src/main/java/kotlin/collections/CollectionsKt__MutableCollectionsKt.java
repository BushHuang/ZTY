...
class CollectionsKt__MutableCollectionsKt extends CollectionsKt__MutableCollectionsJVMKt {
    ...
    public static final <T> boolean removeAll(Collection<? super T> collection, Sequence<? extends T> sequence) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        Intrinsics.checkNotNullParameter(sequence, "elements");
        Collection<?> collectionConvertToSetForSetOperation = BrittleContainsOptimizationKt.convertToSetForSetOperation(sequence);
        return (collectionConvertToSetForSetOperation.isEmpty() ^ true) && collection.removeAll(collectionConvertToSetForSetOperation);
    }
    ...
    public static final <T> boolean retainAll(Collection<? super T> collection, Sequence<? extends T> sequence) {
        ...
        Intrinsics.checkNotNullParameter(sequence, "elements");
        Collection<?> collectionConvertToSetForSetOperation = BrittleContainsOptimizationKt.convertToSetForSetOperation(sequence);
        return collectionConvertToSetForSetOperation.isEmpty() ^ true ? collection.retainAll(collectionConvertToSetForSetOperation) : retainNothing$CollectionsKt__MutableCollectionsKt(collection);
    }
