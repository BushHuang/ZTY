...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final void forEachBlock(File file, int i, Function2<? super byte[], ? super Integer, Unit> function2) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                function2.invoke(r3, Integer.valueOf(i2));
            }
        } finally {
        }
    }
    ...
    public static final List<String> readLines(File file, Charset charset) {
        ...
        FilesKt.forEachLine(file, charset, new Function1<String, Unit>() {
            {
                super(1);
            }
    ...
    public static Object useLines$default(File file, Charset charset, Function1 function1, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Reader inputStreamReader = new InputStreamReader(new FileInputStream(file), charset);
